<template>
    ...
    <div>
      ...
      <div>
      <input type="text" v-model="firstname" placeholder="First name" class="signup1"/>
      </div>

      <div>
      <input type="text" v-model="lastname" placeholder="Last name" class="signup1"/>
      </div>

      <div>
      <input type="text" v-model="username" placeholder="Username" class="signup1"/>
    </div>

    <div>
      <input type="text" v-model="phone" placeholder="Phone number" class="signup1"/>
    </div>
    ...
    <div>
      ...
      <div>
      <input type="password" v-model="createpass" placeholder="Create password" class="signup1"/>
    </div>

    <div>
      <input type="password" v-model="confirmpass" placeholder="Confirm password" class="signup1"/>
    </div>
