                                        ...
                                        <div class="col-md-4">
                                            <div class="product-short">
                                                <div class="dropdown">
                                                    ...
                                                    <select v-model="selectedItem2" id="selectItem" class="dropdown-toggle">
                                                        <option value="" disabled>Product short by</option>
                                                        <option value="dropdown-item">Newest</option>
                                                        <option value="dropdown-item">Popular</option>
                                                        <option value="dropdown-item">Most sale</option>
                                        ...
                                        <div class="col-md-4">
                                            <div class="product-price-range">
                                                <div class="dropdown">
                                                    ...
                                                    <select v-model="selectedItem3" id="selectItem" class="dropdown-toggle">
                                                        <option value="" disabled>Product price range</option>
                                                        
                                                        <option value="dropdown-item">$0 to 50</option>
                                                        <option value="dropdown-item">$51 to 100</option>
                                                        <option value="dropdown-item">$101 to 150</option>
                                                        <option value="dropdown-item">$151 to 200</option>
                                                        <option value="dropdown-item">$201 to 250</option>
                                                        <option value="dropdown-item">$201 to 250</option>
